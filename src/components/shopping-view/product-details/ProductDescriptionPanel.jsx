        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {highlights.map((h, idx) => (
              <div
                key={`${h}-${idx}`}
                className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 text-slate-800 text-sm font-semibold shadow-sm hover:shadow-md hover:border-primary/30 hover:bg-primary/5 transition-all duration-300 group"
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white border border-slate-200 group-hover:border-primary/30 shadow-sm">
